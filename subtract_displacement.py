...
def subtract_disp(Files, column_labels = [["x", "u"],["y", "v"],["z","w"]], subscript = "0"):
    ...
    Files.apply_func_to_data(lambda x:subtract_columns(x,column_labels), labels = [labels[0] for labels in column_labels], out_sub = subscript, message = "Subtracting displacement")
